...
| Main              | Price from : |                                  |
| ----------------- | ------------ | -------------------------------- |
| Custom map design | **49€**      | This covers the main map design. |
...
{% hint style="warning" %}
The extra maps must already have a premade minimap available. For any maps that don’t have a minimap and would require recreating one from scratch, I won’t be responsible for making it.
